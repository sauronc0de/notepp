...
static const EmojiEntry k_smileys[] = {
    ...
    {"🥳","partying"},{"😗","kissing"},{"😚","kissing_closed_eyes"},{"😙","kissing_smiling"},
    {"😛","stuck_out_tongue"},{"😜","winking_tongue"},{"🤪","zany"},{"😝","tongue_closed_eyes"},
    {"😏","smirk"},{"😒","unamused"},{"😞","disappointed"},{"😔","pensive"},
    {"🙁","slightly_frowning"},{"😣","persevere"},{"😫","tired"},{"😩","weary"},
    {"🥺","pleading"},{"😢","cry"},{"😭","sob"},{"😤","triumph"},
    ...
    {"🤐","zipper_mouth"},{"🤨","raised_eyebrow"},{"😶","no_mouth"},{"😐","neutral"},
    {"😑","expressionless"},{"😬","grimacing"},{"🙄","eye_roll"},{"😯","hushed"},
    {"😮","open_mouth"},{"😲","astonished"},{"😌","relieved"},{"😪","sleepy"},
    {"🥱","yawning"},{"😴","sleeping"},{"🤤","drooling"},{"😵","dizzy"},
    {"🤒","sick"},{"🤕","injured"},{"🤢","nauseated"},{"🤮","vomiting"},
    {"🤧","sneezing"},{"🥴","woozy"},{"🤑","money_mouth"},{"🤠","cowboy"},
    {"😈","smiling_devil"},{"👿","angry_devil"},{"💩","poop"},{"🤡","clown"},
    {"👹","ogre"},{"👺","goblin"},{"👻","ghost"},{"💀","skull"},{"☠️","skull_crossbones"},
    {"🤖","robot"},
};

static const EmojiEntry k_people[] = {
    {"👋","wave"},{"🤚","raised_back_hand"},{"🖐","raised_hand"},{"✋","hand"},
    {"🖖","vulcan_salute"},{"👌","ok_hand"},{"🤏","pinching"},{"✌","victory"},
    {"🤞","crossed_fingers"},{"🤟","love_you"},{"🤘","sign_of_horns"},{"🤙","call_me"},
    {"👈","point_left"},{"👉","point_right"},{"👆","point_up"},{"👇","point_down"},
    {"☝","index_up"},{"👍","thumbsup"},{"👎","thumbsdown"},{"✊","fist"},
    {"👊","punch"},{"🤛","left_fist"},{"🤜","right_fist"},{"👏","clap"},
    {"🙌","raised_hands"},{"👐","open_hands"},{"🤲","palms_up"},
    {"🤝","handshake"},{"🙏","pray"},{"💪","muscle"},{"🦾","mechanical_arm"},
    {"🦿","mechanical_leg"},{"🦵","leg"},{"🦶","foot"},{"👀","eyes"},{"👁","eye"},
    {"👅","tongue"},{"👄","lips"},{"👂","ear"},{"🦻","ear_hearing_aid"},
    {"👃","nose"},{"🧠","brain"},{"🦷","tooth"},{"🦴","bone"},{"🫀","heart_anatomy"},
    {"👶","baby"},{"🧒","child"},{"👦","boy"},{"👧","girl"},{"🧑","person"},
    {"👱","blond_person"},{"👨","man"},{"👩","woman"},{"👴","older_man"},{"👵","older_woman"},
...
static const EmojiEntry k_animals[] = {
    ...
    {"🦄","unicorn"},{"🦢","swan"},{"🦚","peacock"},{"🦜","parrot"},
    {"🦩","flamingo"},{"🕊","dove"},{"🐝","bee"},{"🦋","butterfly"},{"🐌","snail"},
    {"🐞","ladybug"},{"🦟","mosquito"},{"🦗","cricket"},{"🦂","scorpion"},
    {"🐢","turtle"},{"🐍","snake"},{"🦎","lizard"},{"🐊","crocodile"},
    {"🦖","t_rex"},{"🦕","sauropod"},{"🐙","octopus"},{"🦑","squid"},
    {"🦞","lobster"},{"🦀","crab"},{"🦐","shrimp"},{"🦈","shark"},
    {"🐬","dolphin"},{"🦭","seal"},{"🐳","whale"},{"🐟","fish"},
    {"🐠","tropical_fish"},{"🐡","blowfish"},{"🐘","elephant"},
    {"🦏","rhino"},{"🦛","hippo"},{"🦒","giraffe"},{"🦓","zebra"},
    {"🦘","kangaroo"},{"🦥","sloth"},{"🦦","otter"},{"🦌","deer"},
    {"🐪","camel"},{"🐫","two_hump_camel"},{"🐇","rabbit2"},{"🐩","poodle"},
    {"🐕","dog2"},{"🐈","cat2"},{"🐓","rooster"},{"🦃","turkey"},
    {"🐾","paw_prints"},
};

static const EmojiEntry k_food[] = {
    {"🍎","apple"},{"🍏","green_apple"},{"🍊","orange"},{"🍋","lemon"},
    {"🍇","grapes"},{"🍈","melon"},{"🍉","watermelon"},{"🍌","banana"},
    {"🍐","pear"},{"🍓","strawberry"},{"🫐","blueberries"},{"🍒","cherries"},
    {"🍑","peach"},{"🍍","pineapple"},{"🥭","mango"},{"🥥","coconut"},{"🥝","kiwi"},
    {"🍅","tomato"},{"🥑","avocado"},{"🍆","eggplant"},{"🥕","carrot"},
    {"🌽","corn"},{"🌶","pepper"},{"🥒","cucumber"},{"🥦","broccoli"},
    {"🥬","leafy_green"},{"🥔","potato"},{"🍠","sweet_potato"},
    {"🧄","garlic"},{"🧅","onion"},{"🥜","peanuts"},{"🍞","bread"},
    {"🥐","croissant"},{"🧀","cheese"},{"🥚","egg"},{"🍳","cooking"},
    {"🥞","pancakes"},{"🧇","waffle"},{"🥓","bacon"},{"🥩","meat"},
    {"🍗","chicken_leg"},{"🌭","hotdog"},{"🍔","burger"},{"🍟","fries"},
    {"🍕","pizza"},{"🌮","taco"},{"🌯","burrito"},{"🧆","falafel"},
    {"🥙","stuffed_flatbread"},{"🥗","salad"},{"🥘","shallow_pan"},
    {"🍣","sushi"},{"🍤","fried_shrimp"},{"🍥","fish_cake"},{"🍜","ramen"},
    {"🍝","spaghetti"},{"🍲","stew"},{"🍛","curry"},{"🍱","bento"},
    {"🥟","dumpling"},{"🍙","rice_ball"},{"🍚","rice"},
    {"🍦","soft_ice_cream"},{"🍧","shaved_ice"},{"🍨","ice_cream"},
    {"🧁","cupcake"},{"🍰","shortcake"},{"🎂","birthday"},{"🥧","pie"},
    {"🍮","custard"},{"🍯","honey"},{"🍭","lollipop"},{"🍬","candy"},
    {"🍫","chocolate"},{"🍿","popcorn"},{"🍩","donut"},{"🍪","cookie"},
    {"☕","coffee"},{"🍵","tea"},{"🧃","juice"},{"🥤","cup_straw"},
    {"🧋","bubble_tea"},{"🥛","milk"},{"🧉","mate"},{"🧊","ice_cube"},
    {"🍶","sake"},{"🍸","cocktail"},{"🍹","tropical_drink"},
    {"🍺","beer"},{"🍻","beers"},{"🥂","clinking_glasses"},
    {"🍷","wine"},{"🥃","tumbler"},{"🍾","champagne"},{"🧂","salt"},
};

static const EmojiEntry k_travel[] = {
    {"✈️","airplane"},{"🛩","small_plane"},{"🛫","takeoff"},{"🛬","landing"},
    {"🚀","rocket"},{"🛸","ufo"},{"🚁","helicopter"},
    {"🚗","car"},{"🚕","taxi"},{"🚙","suv"},{"🛻","pickup"},
    {"🚌","bus"},{"🚑","ambulance"},{"🚒","fire_truck"},{"🚓","police_car"},
    {"🏍","motorcycle"},{"🚲","bike"},{"🛴","scooter"},{"🚜","tractor"},
    {"🚛","truck"},{"🚂","train"},{"🚃","railcar"},{"🚄","bullet_train"},
    {"🚅","shinkansen"},{"🚆","train2"},{"🚇","metro"},{"🚈","light_rail"},
    {"🚉","station"},{"🚊","tram"},{"🛳️","cruise_ship"},{"🚢","ship"},
    {"⛵","sailboat"},{"⚓","anchor"},{"🗺","world_map"},{"🏔","mountain"},
    {"⛰️","mountain_snow"},{"🌋","volcano"},{"🏕","camping"},{"🏖","beach"},
    {"🏜","desert"},{"🏝","island"},{"🏞","national_park"},{"🏟","stadium"},
    ...
    {"🕍","synagogue"},{"🕋","kaaba"},{"⛺","tent"},
    {"🌁","foggy"},{"🌃","night_stars"},{"🌄","sunrise_mountains"},
    {"🌅","sunrise"},{"🌆","cityscape_dusk"},{"🌇","city_sunset"},
    {"🌉","bridge_night"},{"🌌","milky_way"},
...
static const EmojiEntry k_activities[] = {
    ...
    {"🥏","flying_disc"},{"🎱","billiards"},{"🏓","ping_pong"},{"🏸","badminton"},
    {"🥊","boxing_glove"},{"🥋","martial_arts"},{"⛷","skier"},{"🏂","snowboarder"},
    {"🎣","fishing"},{"🤿","diving"},{"🏹","archery"},{"🛷","sled"},
    {"🥌","curling_stone"},{"🎽","running_shirt"},{"🎿","skis"},
    {"🥇","gold_medal"},{"🥈","silver_medal"},{"🥉","bronze_medal"},
    {"🏅","sports_medal"},{"🎖","military_medal"},
    {"🎭","performing_arts"},{"🎨","artist_palette"},
    {"🎪","circus_tent"},{"🧩","puzzle_piece"},{"🪀","yo_yo"},{"🪁","kite"},
};

static const EmojiEntry k_objects[] = {
    {"💡","bulb"},{"🔦","flashlight"},{"🕯️","candle"},{"🧯","extinguisher"},
    {"💰","money_bag"},{"💵","dollar"},{"💳","credit_card"},{"🪙","coin"},
    {"💎","gem"},{"💍","ring"},{"👓","glasses"},{"🕶","sunglasses"},
    {"📱","phone"},{"💻","laptop"},{"🖥️","desktop"},{"⌨️","keyboard"},
    {"🖱️","mouse"},{"💾","floppy"},{"💿","cd"},{"📷","camera"},
    {"📸","camera_flash"},{"📹","video_camera"},{"📺","tv"},{"📻","radio"},
    {"⌚","watch"},{"⏰","alarm"},{"⏱️","stopwatch"},{"⌛","hourglass"},{"⏳","hourglass_flowing"},{"🧭","compass"},
    {"🔧","wrench"},{"🪛","screwdriver"},{"🔨","hammer"},{"🔩","nut_bolt"},
    {"🧰","toolbox"},{"🧲","magnet"},{"🔗","link"},{"⚔️","crossed_swords"},
    {"🛡️","shield"},{"🔪","knife"},
    ...
    {"🏆","trophy"},{"🎁","gift"},{"🎉","party_popper"},
    {"✨","sparkles"},{"🎊","confetti"},{"🎀","ribbon"},
    {"📚","books"},{"📖","open_book"},{"📓","notebook"},{"📕","closed_book"},
    {"📝","memo"},{"✏️","pencil"},{"🖊️","pen"},{"📐","triangular_ruler"},
    {"📏","ruler"},{"📋","clipboard"},{"📅","calendar"},{"📊","bar_chart"},
    {"📈","chart_up"},{"📉","chart_down"},
    {"📌","pushpin"},{"📎","paperclip"},{"🔍","magnifier"},{"🔭","telescope"},
    {"🔬","microscope"},{"🧬","dna"},{"💊","pill"},{"💉","syringe"},
    {"🩺","stethoscope"},{"🩸","drop_of_blood"},{"🩹","bandage"},
    {"✉️","envelope"},{"📧","email"},{"📦","package"},{"🗑️","wastebasket"},
    {"🧸","teddy_bear"},{"🔮","crystal_ball"},
    {"🧹","broom"},{"🧺","basket"},{"🚿","shower"},{"🧼","soap"},
    {"🧴","lotion"},{"🪒","razor"},
};

static const EmojiEntry k_nature[] = {
    {"💐","bouquet"},{"🌸","cherry_blossom"},{"💮","white_flower"},
    {"🪷","lotus"},{"🌼","blossom"},{"🌻","sunflower"},{"🌺","hibiscus"},
    {"🌹","rose"},{"🥀","wilted"},{"🌷","tulip"},{"🪴","potted_plant"},
    {"🌱","seedling"},{"🌿","herb"},{"☘️","shamrock"},{"🍀","four_leaf"},
    {"🍃","leaves"},{"🍂","fallen_leaf"},{"🍁","maple"},{"🌾","sheaf"},
    {"🌵","cactus"},{"🎄","christmas_tree"},{"🌴","palm"},{"🌳","tree"},
    {"🌲","evergreen"},{"🪵","wood"},{"🍄","mushroom"},{"🌰","chestnut"},
    {"🦔","hedgehog"},{"☀️","sun"},{"🌞","sun_face"},{"🌑","new_moon"},
    {"🌕","full_moon"},{"🌝","full_moon_face"},{"🌚","new_moon_face"},
    {"🌛","first_quarter_face"},{"🌜","last_quarter_face"},{"🌙","crescent"},
    {"⭐","star"},{"🌟","glowing_star"},{"💫","dizzy_star"},{"🌠","shooting_star"},
    {"🪐","ringed_planet"},{"🌏","earth_asia"},{"🌍","earth_africa"},{"🌎","earth_americas"},
    {"☁️","cloud"},{"⛅","partly_cloudy"},{"🌤️","sun_small_cloud"},
    {"🌥️","sun_behind_cloud"},{"🌦️","rain"},{"🌧️","cloud_rain"},
    {"⛈️","thunder"},{"🌨️","snow_cloud"},{"🌫️","fog"},{"🌬️","wind_face"},
    {"❄️","snowflake"},{"⛄","snowman"},{"🌡️","thermometer"},
    {"☔","umbrella_rain"},{"🌪️","tornado"},{"🌀","cyclone"},
    {"🌈","rainbow"},{"🔥","fire"},{"💧","droplet"},
    {"🌊","ocean"},{"💦","sweat_droplets"},{"⚡","lightning"},
};
...
static const EmojiEntry k_symbols[] = {
    ...
    {"‼️","double_exclamation"},{"🔞","no_eighteen"},
    {"➕","plus"},{"➖","minus"},{"✖️","multiply"},{"➗","divide"},
    {"♾️","infinity"},{"☮️","peace"},
    {"🆕","new"},{"🆒","cool"},{"🆓","free"},{"🆗","ok"},{"🆙","up"},{"🆚","vs"},
    ...
    {"⬆️","up_arrow"},{"➡️","right_arrow"},{"⬇️","down_arrow"},{"⬅️","left_arrow"},
    {"↗️","up_right"},{"↘️","down_right"},{"↙️","down_left"},{"↖️","up_left"},
    {"🔼","up_button"},{"🔽","down_button"},{"⏫","fast_up"},{"⏬","fast_down"},
    {"🔙","back"},{"🔚","end"},{"🔛","on"},{"🔜","soon"},{"🔝","top"},
    {"▶️","play"},{"⏩","fast_forward"},{"⏸️","pause"},{"⏹️","stop"},
    {"🔀","shuffle"},{"🔁","repeat"},{"🔂","repeat_one"},
    {"🔇","muted"},{"🔈","speaker"},{"🔉","sound"},{"🔊","loud_sound"},
    {"🔱","trident"},{"⚜️","fleur_de_lis"},
